...
var y = "+\u2012\u2013-|\u2502\u2500".split(""), z = ["\u25b6", "\u25c0", "\u25b2", "\u25bc"], ga = y.concat(z), B = "ontouchstart" in window || "onmsgesturechange" in window, C = new p(-1, 0), D = new p(1, 0), F = new p(0, -1), G = new p(0, 1), H = [C, D, F, G];
function I(a, b) {
...
function na(a, b) {
  ...
  if (f && 3 == N(c)) {
    ...
    if (!c.c) {
      return console.log("Up arrow", "alt special", 3), "\u25b2";
    }
    if (!c.b) {
      return "\u25bc";
    }
  ...
  if (f && 1 == N(c)) {
    ...
    if (c.b) {
      return console.log("Up arrow", "alt special", 1), "\u25b2";
    }
    if (c.right) {
      return "\u25c0";
    }
...
;function V(a, b, c, d, e) {
  ...
  for (;l++ < f;) {
    q = new p(E, l), L = T(a, new p(E, l)), " " == e && 2 == L.a + L.right || ma(a, q, "\u2502");
  }
  P(a, b, e);
  P(a, c, e);
  ma(a, new p(E, d), e);
...
g.i = function(a) {
  ...
  V(this.a, this.b, a, !0);
  V(this.a, this.b, a, !1);
  var b = this.b, c = Math.min(b.x, a.x), d = Math.max(b.x, a.x), e = Math.min(b.y, a.y);
  a = Math.max(b.y, a.y);
  P(this.a, new p(c, e), "\u250c");
  P(this.a, new p(d, e), "\u2510");
  P(this.a, new p(d, a), "\u2518");
